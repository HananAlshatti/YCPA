...
%this is for plot and changing it changes the plot figures
movie = 1;
Plot.off = 0;
Plot.pl = 0;
Plot.ori = '13';
...
% Boudary conditions 2 and 3 added to do creative task
bc{1}.NumS = 1;
...
betap = 0;
t0 = 30e-15;
%Simulate the grating. You might find it useful to set the “st” paramater to -0.05. What did that do?
%Made it much more organized and clear 
st = -0.05;
s = 0;
y0 = yMax/2;
sty = 1.5*lambda;
